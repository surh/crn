...
Dat = CSV.read("/Users/sur/lab/exp/2025/today2/indiv_growth_curve.tsv", 
    DataFrame, delim='\t')
outdir = "/Users/sur/lab/exp/2025/today2/single_strain_bytemp_logistic/"
...
for strain in Strains
    ...
    for temp in temps
        i = 1
        obsdata = Array{Tuple{Vector, Vector}}(undef, length(batches))
        ...
        # Get posterior samples and save to file
        Post = DataFrame(chain)
        outfile = joinpath(outdir, "$(strain)_$(temp)_logistic_fit.tsv")
